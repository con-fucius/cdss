...
UMLS data models
"""
from sqlalchemy import Column, String, Text, ARRAY, Index
...
class UMLSConcept(Base):
    ...
    meta_data = Column(JSONB, name='metadata')  # Use meta_data as attribute name, but keep 'metadata' as column name

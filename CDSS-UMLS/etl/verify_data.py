...
def run_verification():
    ...
    try:
        with engine.connect() as conn:
            ...
            results.append(
                ["Unique CUIs", f"{unique_cuis:,}", f"Should match total ({total_concepts:,})"]
            )
            ...
            results.append(
                ["Concepts without Preferred Name", f"{no_preferred:,}", "0 (all should have)"]
            )
            ...
            results.append(
                ["Concepts without Semantic Types", f"{no_semantic_types:,}", "Some (OK)"]
            )
            ...
            results.append(
                ["Concepts with Embeddings", f"{with_embeddings:,}", "~3.18M (after generation)"]
            )
            ...
            results.append(
                ["Orphaned Relations (cui1)", f"{orphaned_cui1:,}", "0 (data integrity)"]
            )
            ...
            results.append(
                ["Orphaned Relations (cui2)", f"{orphaned_cui2:,}", "0 (data integrity)"]
            )
